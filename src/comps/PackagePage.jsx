...
const PackagePage = () => {
  return (
    ...
    >
      <div className="wrapper my-10 border border-gray-200 w-2/3 mx-auto pt-16 pb-5 px-14 relative">
        {/* Avatar-img */}
        ...
        {/* title */}
        <h1 className="package-title text-3xl text-blue-600 font-light mb-10">
          Got it! Which would you like?
        </h1>

        {/* input */}
        <div className="input-group flex items-center mb-8 relative ">
          <input
            type="text"
          ...
          <Btn
            text="Search Package"
            extraClasses="bg-blue-600 text-white absolute right-px"
          />
        </div>

        {/* Packages */}
        <div className="packages-wrapper grid grid-cols-4 gap-8">
